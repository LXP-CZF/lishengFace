<template>
 <div id="app">
    <el-row>
    <el-col :span="24">
    <el-table size="mini" :data="this.master_user.data" border style="width: 97%" highlight-current-row>
    ...
    <el-col :span="24">
    <div class="el-table-add-row" style="width: 97%;" @click="addMasterUser()"><span>+ 添加</span></div>
    </el-col>
    </el-row>
